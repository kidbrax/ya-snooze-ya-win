...
const AsyncOptionsPage = React.lazy(() => import('./components/OptionsPage'))
const AsyncFirstSnoozeDialog = React.lazy(() => import('./components/dialogs/FirstSnoozeDialog'))
const AsyncSupportTSDialog = React.lazy(() => import('./components/dialogs/SupportTSDialog'))
// const AsyncBetaDialog = React.lazy(() =>
//   import('./components/dialogs/BetaDialog')
// );
const AsyncTutorial = React.lazy(() => import('./components/dialogs/Tutorial'))
const AsyncWhatsNewDialog = React.lazy(() => import('./components/dialogs/WhatsNewDialog'))
  ...
  <HashRouter hashType="noslash">
    <Suspense fallback={<div style={{ padding: '10px', textAlign: 'center' }}>Loading...</div>}>
      <Routes>
        ...
        <Route path={FIRST_SNOOZE_PATH} element={<AsyncFirstSnoozeDialog />} />
