...
const UpgradeDialog = (props) => {
  ...
  return (
    <SnoozeModal visible={visible}>
      <Root>
        <Star src={starImage} />
        <Title>{/* Become a Ya Snooze, Ya Win <ProBadge big /> ! */}</Title>
        <Subtitle>
          Help us support this extension development and enjoy unlimited tab snoozing!
          <br />
          <br />
          You have used your {FREE_WEEKLY_SNOOZE_COUNT} free weekly snoozes.
        </Subtitle>
        ...
        <NoThanksButton raised onClick={onDismiss} disabled={!canContinue}>
